...
<body>
	...
	<form action="EditProductServlet" method="post">
		...
		Mã hàng: <input type="text" value="<%=maHH%>" disabled="disabled" /> <input
			type="hidden" name="maHH" value="<%=maHH%>" /> Tên hàng: <input
			type="text" name="tenHH" id="tenHH" value="<%=tenHH%>" /> Đơn vị
		tính: <input type="text" name="dvt" id="dvt" value="<%=dvt%>" /> Đơn
		giá tham khảo: <input type="text" name="donGiaTK" id="donGiaTK"
			value="<%=donGiaTK%>" /> Ghi chú: <input type="text" name="ghiChu"
			value="<%=ghiChu%>" /> <input type="submit" onclick="return true"
			value="Sửa" /> <input type="reset" value="Hủy bỏ" />
